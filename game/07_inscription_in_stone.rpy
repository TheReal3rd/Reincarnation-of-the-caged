...
label inscription_in_stone:#100% complete Test done some narration needs work and but functional.
    ...
    scene image "07_inscription_in_stone/15_bg_progression_shot.png"
    ...
    scene image "07_inscription_in_stone/31_encounter_3.png"
    blackBird "BE HUMAN"
    ...
    "Stepping out of the darkness, They find themselves in a land of mirrors—endless reflections stretching in every direction."
    ...
    #As this one give details to the story i'll keep it. The detail wasn't substantial enough and broke the tell of it.
